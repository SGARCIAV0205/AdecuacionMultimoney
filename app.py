...
from procesador_variables import procesar_json
...
if uploaded_files:
    ...
    if resultados:
        ...
        # DESCARGA JSON
        # ----------------------------------------------------
        json_output = json.dumps(resultados, indent=4, default=str)

        st.download_button(
            label="Descargar JSON",
            data=json_output,
            file_name="output_modelo_multimoney.json",
